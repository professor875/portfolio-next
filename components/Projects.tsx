    ...
    return (
        <div className="grid md:grid-cols-2 gap-8 mt-10 md:mt-20 mx-auto max-w-[1100px] scroll-mt-20" id="projects">
            ...
            {projects.map((project, index) => (
                <div
                    className={`border border-white/40 shadow hover:shadow-xl shadow-cyan-400 transition-all duration-300 cursor-pointer hover:scale-105 w-full grid rounded-[10px] overflow-hidden bg-black p-4 md:p-8 ${index === 1 ? ' md:translate-y-[-30%] lg:translate-y-[-50%] ' : ''}`}
                    key={index}>
